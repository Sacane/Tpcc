...
static const yytype_uint8 yyrline[] =
{
      ...
      59,    60,    63,    64,    67,    68,    70,    73,    74,    77,
      78,    79,    80,    81,    82,    83,    84,    85,    86,    87,
      89,    90,    92,    93,    95,    96,    98,    99,   101,   102,
     104,   105,   107,   108,   109,   110,   111,   112,   113,   116,
...
static const char *const yytname[] =
{
  ...
  "ELSE", "FOR", "VOID", "SWITCH", "DEFAULT", "CASE", "BREAK", "PUTCHAR",
  "NUM", "IDENT", "TYPE", "DIVSTAR", "ADDSUB", "CHARACTER", "EQ", "ORDER",
  "';'", "','", "'('", "')'", "'{'", "'}'", "'='", "'!'", "':'", "$accept",
...
static const yytype_int16 yytoknum[] =
{
     ...
     275,   276,   277,   278,    59,    44,    40,    41,   123,   125,
      61,    33,    58
};
# endif
...
{
     -89,    28,    -5,   -89,    43,    45,    -2,   -89,    25,    41,
      52,   -10,    55,   -89,   -89,   -89,     2,     2,   -89,    56,
      52,    61,   -89,    64,    58,    57,    60,   -89,    75,    12,
     -89,   -89,    76,   -89,   -89,    89,    70,    71,    74,    77,
      78,   -89,   -89,   -89,   -89,    72,    90,   -89,    85,   101,
     -89,   -89,   101,   101,     6,   110,    94,    96,   103,   105,
     -89,   -89,   101,   101,   101,   101,   101,    37,   101,   -89,
     101,   -89,    -1,   -89,   101,   -89,   101,   101,   101,   101,
     101,    22,    36,    47,   122,    99,   104,   106,   -89,    53,
     107,   -89,   110,    94,    96,   103,   105,   -89,    40,    40,
     100,   111,   101,   112,   -89,   -89,   -89,   123,   -89,   -89,
     122,   -89,    40,    40,   -89,    46,    98,   101,   -89,   -89,
     -89,     3,    84,   -89,   -89,   113,   -89,   -89
};
...
static const yytype_int8 yydefact[] =
{
      ...
      15,    11,     0,    10,     6,     0,     0,     0,     0,     0,
      49,    29,    18,    16,    17,     0,     0,    45,    49,     0,
      46,    26,     0,     0,     0,    31,    33,    35,    37,    39,
      41,    47,     0,     0,     0,    57,    57,     0,     0,    14,
      57,    42,     0,    43,     0,    25,     0,     0,     0,     0,
       0,     0,     0,     0,    59,     0,    56,     0,    28,     0,
       0,    44,    30,    32,    34,    36,    38,    40,     0,     0,
       0,     0,     0,     0,    19,    48,    22,    20,    18,    27,
      58,    23,     0,    51,    21,     0,     0,     0,    24,    50,
      18,     0,    55,    53,    18,     0,    52,    54
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
     -89,   -89,   124,   -89,   -89,   133,   -89,   125,   -89,   -89,
     -20,   -88,   -31,    66,    65,    67,    68,    69,   -46,   -29,
     -89,   -89,    19,    10,   -89
};
...
static const yytype_int8 yydefgoto[] =
{
     ...
     122,    44,    84,    55,    56,    57,    58,    59,    60,    61,
     115,   119,   123,    85,    86
};
...
{
      45,    29,    74,    71,    54,     4,    74,    73,     4,    74,
     106,   107,    22,     5,    18,    19,    12,    35,    36,    37,
      23,    72,    67,    38,   114,    74,    91,    39,     3,    40,
      75,    81,    82,    83,    97,   124,    41,    89,    45,    74,
      42,    43,    35,    36,    37,    35,    36,    37,    38,    98,
      74,    38,    39,    14,    40,    39,    74,    40,   116,   117,
       9,    41,    10,    99,    41,    42,    88,    16,    42,    45,
      45,   110,    20,    27,   100,   118,    87,   104,    17,    28,
      90,    30,    32,    45,    45,    31,   121,    33,   113,    35,
      36,    37,    34,    45,    46,    38,    62,    63,   125,    39,
      64,    40,    68,    65,    66,    47,    48,    69,    41,    49,
      50,    70,    42,    51,    76,    52,    77,    47,    48,    78,
      53,    49,    50,    79,    80,    74,   101,    52,   108,   102,
     120,   112,    53,   103,   105,   109,   111,   127,    21,    13,
      92,    93,    26,   126,    94,     0,    95,     0,    96
};

static const yytype_int8 yycheck[] =
{
      29,    21,     3,    49,    35,    10,     3,    53,    10,     3,
      98,    99,    10,    18,    24,    25,    18,     5,     6,     7,
      18,    52,    42,    11,   112,     3,    27,    15,     0,    17,
      24,    62,    63,    64,    80,    32,    24,    68,    67,     3,
      28,    29,     5,     6,     7,     5,     6,     7,    11,    27,
       3,    11,    15,    28,    17,    15,     3,    17,    12,    13,
      17,    24,    17,    27,    24,    28,    29,    26,    28,    98,
      99,   102,    17,    17,    27,    29,    66,    24,    26,    18,
      70,    17,    25,   112,   113,    27,   117,    27,   108,     5,
       6,     7,    17,   122,    18,    11,    26,    26,    14,    15,
      26,    17,    30,    26,    26,    16,    17,    17,    24,    20,
      21,    26,    28,    24,     4,    26,    22,    16,    17,    23,
      31,    20,    21,    20,    19,     3,    27,    26,    28,    25,
      32,     8,    31,    27,    27,    24,    24,    24,    14,     6,
      74,    76,    17,   124,    77,    -1,    78,    -1,    79
};
...
{
       0,    34,    35,     0,    10,    18,    37,    38,    39,    17,
      17,    36,    18,    38,    28,    42,    26,    26,    24,    25,
      17,    35,    10,    18,    40,    41,    40,    17,    18,    43,
      17,    27,    25,    27,    17,     5,     6,     7,    11,    15,
      17,    24,    28,    29,    44,    52,    18,    16,    17,    20,
      21,    24,    26,    31,    45,    46,    47,    48,    49,    50,
      51,    52,    26,    26,    26,    26,    26,    43,    30,    17,
      26,    51,    45,    51,     3,    24,     4,    22,    23,    20,
      19,    45,    45,    45,    45,    56,    57,    56,    29,    45,
      56,    27,    46,    47,    48,    49,    50,    51,    27,    27,
      27,    27,    25,    27,    24,    27,    44,    44,    28,    24,
      45,    24,     8,    43,    44,    53,    12,    13,    29,    54,
      32,    45,    43,    55,    32,    14,    55,    24
};
...
#line 79 "src/parser.y"
                                            {(yyval.node) = makeNode(If); addChild((yyval.node), (yyvsp[-4].node)); addChild((yyval.node), (yyvsp[-2].node)); Node *else_n = makeNode(Else); addSibling((yyvsp[-4].node), else_n); addChild(else_n, (yyvsp[0].node));}
...
#line 81 "src/parser.y"
                                            {(yyval.node) = makeNode(FunctionCall); (yyval.node)->lineno = lineno; strcpy((yyval.node)->u.ident, (yyvsp[-4].ident)); addChild((yyval.node), (yyvsp[-2].node));}
...
#line 85 "src/parser.y"
                                             {(yyval.node) = makeNode(Putchar); addChild((yyval.node),(yyvsp[-2].node));}
...
#line 127 "src/parser.y"
                             {if((yyvsp[-2].node)) {(yyval.node) = (yyvsp[-2].node); addSibling((yyval.node), makeNode(Break));} else {(yyval.node) = makeNode(Break);}}
