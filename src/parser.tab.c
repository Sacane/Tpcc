...
static const yytype_uint8 yyrline[] =
{
      ...
      52,    53,    56,    57,    60,    61,    63,    66,    67,    70,
      71,    72,    73,    74,    75,    76,    77,    78,    79,    81,
      82,    84,    85,    87,    88,    90,    91,    93,    94,    96,
      97,    99,   100,   101,   102,   103,   104,   105,   108,   112,
     113,   116,   117,   118,   119,   122,   125,   126,   129,   130
};
#endif
...
{
  "$end", "error", "$undefined", "DIVSTAR", "ADDSUB", "ORDER", "TYPE",
  "EQ", "OR", "AND", "CHARACTER", "RETURN", "WHILE", "IF", "ELSE", "FOR",
  "VOID", "SWITCH", "DEFAULT", "CASE", "BREAK", "NUM", "IDENT", "';'",
  "','", "'('", "')'", "'{'", "'}'", "'='", "'!'", "':'", "$accept",
...
{
    -111,    18,    64,  -111,    13,    19,    70,  -111,    26,    37,
     -13,    39,    49,  -111,  -111,  -111,    86,  -111,    55,    86,
      37,    73,    63,  -111,    61,    66,  -111,    65,    78,    27,
    -111,  -111,    99,  -111,  -111,    -1,    87,    88,    90,    91,
    -111,  -111,  -111,  -111,    74,    95,    21,  -111,  -111,    93,
    -111,    21,    21,    -4,   112,   115,   118,   121,   123,  -111,
    -111,    21,    21,   105,    21,    46,    21,  -111,  -111,    21,
      -3,  -111,    21,  -111,    21,    21,    21,    21,    21,     4,
       7,   102,   122,   103,   107,  -111,    29,   106,  -111,   112,
     115,   118,   121,   123,  -111,    97,    97,   108,   110,    21,
    -111,  -111,  -111,   120,    -5,  -111,   122,    97,   109,    35,
      71,  -111,  -111,  -111,   111,   113,  -111,    -5,    84,  -111,
    -111,  -111,  -111,   114,  -111,  -111,    -5,  -111
};
...
static const yytype_int8 yydefact[] =
{
      ...
      15,    10,     0,    11,     6,     0,     0,     0,     0,    48,
      28,    18,    16,    17,     0,     0,     0,    45,    44,    48,
      26,     0,     0,     0,    30,    32,    34,    36,    38,    40,
      46,     0,     0,     0,    57,     0,     0,    14,    41,    57,
       0,    42,     0,    25,     0,     0,     0,     0,     0,     0,
       0,     0,    59,     0,    56,    27,     0,     0,    43,    29,
      31,    33,    35,    37,    39,     0,     0,     0,     0,     0,
      19,    47,    23,    20,    54,    24,    58,     0,     0,     0,
       0,    50,    21,    18,     0,     0,    22,    54,     0,    53,
      18,    18,    49,     0,    51,    52,    54,    55
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
    -111,  -111,   124,  -111,  -111,   130,  -111,   126,  -111,  -111,
     -15,   -35,   -34,    67,    69,    72,    75,    76,   -44,   -29,
    -111,  -110,   -73,    77,  -111
};
...
static const yytype_int8 yydefgoto[] =
{
     ...
     118,    43,    82,    54,    55,    56,    57,    58,    59,    60,
     110,   111,   119,    83,    84
};
...
{
      44,    53,    68,    46,    72,    72,    29,   122,    71,    47,
      17,    18,    72,   108,   109,    72,   127,    70,     3,    73,
      48,    49,    50,    88,    51,    46,    65,    79,    80,    52,
      95,    47,    86,    96,    94,     9,    44,    72,    35,    36,
      37,    11,    48,    49,    38,   114,    51,   124,   125,    39,
      40,    52,   100,    14,    41,    42,   115,    35,    36,    37,
     102,   103,    16,    38,    19,   106,    44,    44,    39,    40,
       4,    20,   112,    41,    85,   117,    12,    26,    44,    28,
       5,    44,    35,    36,    37,    30,     5,    31,    38,    44,
      32,    33,    22,    39,    40,    35,    36,    37,    41,   116,
      34,    38,    23,    66,   123,    45,    39,    40,    35,    36,
      37,    41,    61,    62,    38,    63,    64,    67,    69,    39,
      40,    74,    75,    76,    41,    77,    78,    81,    97,    98,
      72,    99,   101,   105,   107,   104,    13,   126,    21,    89,
     113,     0,   120,    90,   121,    27,    87,    91,     0,     0,
       0,    92,     0,    93
};

static const yytype_int8 yycheck[] =
{
      29,    35,    46,     4,     8,     8,    21,   117,    52,    10,
      23,    24,     8,    18,    19,     8,   126,    51,     0,    23,
      21,    22,    23,    26,    25,     4,    41,    61,    62,    30,
      26,    10,    66,    26,    78,    22,    65,     8,    11,    12,
      13,    22,    21,    22,    17,    10,    25,   120,   121,    22,
      23,    30,    23,    27,    27,    28,    21,    11,    12,    13,
      95,    96,    25,    17,    25,    99,    95,    96,    22,    23,
       6,    22,   107,    27,    28,   110,     6,    22,   107,     6,
      16,   110,    11,    12,    13,    22,    16,    26,    17,   118,
      24,    26,     6,    22,    23,    11,    12,    13,    27,    28,
      22,    17,    16,    29,    20,     6,    22,    23,    11,    12,
      13,    27,    25,    25,    17,    25,    25,    22,    25,    22,
      23,     9,     7,     5,    27,     4,     3,    22,    26,    26,
       8,    24,    26,    23,    14,    27,     6,    23,    14,    72,
      31,    -1,    31,    74,    31,    19,    69,    75,    -1,    -1,
      -1,    76,    -1,    77
};
...
{
       0,    33,    34,     0,     6,    16,    36,    37,    38,    22,
      35,    22,     6,    37,    27,    41,    25,    23,    24,    25,
      22,    34,     6,    16,    39,    40,    22,    39,     6,    42,
      22,    26,    24,    26,    22,    11,    12,    13,    17,    22,
      23,    27,    28,    43,    51,     6,     4,    10,    21,    22,
      23,    25,    30,    44,    45,    46,    47,    48,    49,    50,
      51,    25,    25,    25,    25,    42,    29,    22,    50,    25,
      44,    50,     8,    23,     9,     7,     5,     4,     3,    44,
      44,    22,    44,    55,    56,    28,    44,    55,    26,    45,
      46,    47,    48,    49,    50,    26,    26,    26,    26,    24,
      23,    26,    43,    43,    27,    23,    44,    14,    18,    19,
      52,    53,    43,    31,    10,    21,    28,    43,    42,    54,
      31,    31,    53,    20,    54,    54,    23,    53
};
...
#line 41 "src/parser.y"
                                        {(yyval.node) = (yyvsp[-2].node); addChild((yyval.node), makeNode(id));}
#line 1448 "parser.tab.c"
    break;

  case 6:
#line 42 "src/parser.y"
                                        {(yyval.node) = makeNode(types); addChild((yyval.node), makeNode(id));}
...
#line 52 "src/parser.y"
                                        {(yyval.node) = makeNode(EnTeteFonct); Node * type = makeNode(types); addChild((yyval.node), type); addChild(type, makeNode(id)); addChild((yyval.node), (yyvsp[-1].node));}
#line 1478 "parser.tab.c"
    break;

  case 11:
#line 53 "src/parser.y"
                                        {(yyval.node) = makeNode(EnTeteFonct); Node * type = makeNode(types); addChild((yyval.node), makeNode(Void)); addChild(type, makeNode(id)); addChild((yyval.node), (yyvsp[-1].node));}
...
#line 60 "src/parser.y"
                                        {(yyval.node) = (yyvsp[-3].node); Node *type = makeNode(types); addSibling((yyval.node), type); addChild(type, makeNode(id));}
...
#line 75 "src/parser.y"
                                            {(yyval.node) = makeNode(types); addChild((yyval.node), (yyvsp[-2].node));}
...
#line 105 "src/parser.y"
                                            {(yyval.node) = makeNode(FunctionCall); addChild((yyval.node), (yyvsp[-1].node));}
...
#line 129 "src/parser.y"
                            {(yyval.node) = makeNode(ListExp); addSibling((yyval.node), (yyvsp[0].node));}
